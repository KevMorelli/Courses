...
namespace StarWarsSample.Core.ViewModels
{
    public class MenuViewModel : BaseViewModel
    {
        ...
        public MenuViewModel(IMvxNavigationService navigationService)
        {
            ...
            ShowStarshipsCommand = new MvxAsyncCommand(async () => await _navigationService.Navigate<StarshipsViewModel>());
        }
        ...
        public IMvxCommand ShowStarshipsCommand { get; private set; }
